...
<body>
    ...
    <div>
        <div id="head_1">
            <div id="head_content">
                <asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="~/image/home1.gif" /><span
                    style="font-size: 15pt; font-weight: bold; color: #999999;">大学在线考试系统</span></div>
        </div>
        <div class="clear">
        </div>
        <div id="middle">
        ...
        <div id="s_c">
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4"
                ...
                PageSize="7" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px">
                <Columns>
        ...
        <div class="c_img">
            <img src="../image/illust02_07.jpg" /></div>
        <div id="bottom">
            <div class="footer">
